...
Generate content for section `section-01-assessment` (filename: `section-01-assessment.md`).
...
for `section-01-assessment` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-backend-eval/sections/section-01-assessment.md`
