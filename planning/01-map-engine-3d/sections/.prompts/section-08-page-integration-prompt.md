...
Generate content for section `section-08-page-integration` (filename: `section-08-page-integration.md`).
...
for `section-08-page-integration` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/01-map-engine-3d/sections/section-08-page-integration.md`
