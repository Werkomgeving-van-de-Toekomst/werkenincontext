...
Generate content for section `section-03-terrain-encoding` (filename: `section-03-terrain-encoding.md`).
...
for `section-03-terrain-encoding` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/01-map-engine-3d/sections/section-03-terrain-encoding.md`
