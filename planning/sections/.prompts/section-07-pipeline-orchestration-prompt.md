...
Generate content for section `section-07-pipeline-orchestration` (filename: `section-07-pipeline-orchestration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/marc/Projecten/iou-modern/planning/claude-plan.md` - Full implementation plan
2. `/Users/marc/Projecten/iou-modern/planning/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/marc/Projecten/iou-modern/planning/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-pipeline-orchestration` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-07-pipeline-orchestration.md`
