...
Generate content for section `section-06-review-agent` (filename: `section-06-review-agent.md`).
...
for `section-06-review-agent` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-06-review-agent.md`
