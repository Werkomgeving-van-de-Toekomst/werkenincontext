...
Generate content for section `section-08-api-layer` (filename: `section-08-api-layer.md`).
...
for `section-08-api-layer` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-08-api-layer.md`
