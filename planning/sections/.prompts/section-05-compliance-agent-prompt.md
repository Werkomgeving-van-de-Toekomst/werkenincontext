...
Generate content for section `section-05-compliance-agent` (filename: `section-05-compliance-agent.md`).
...
for `section-05-compliance-agent` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-05-compliance-agent.md`
