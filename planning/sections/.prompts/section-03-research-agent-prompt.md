...
Generate content for section `section-03-research-agent` (filename: `section-03-research-agent.md`).
...
for `section-03-research-agent` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-03-research-agent.md`
