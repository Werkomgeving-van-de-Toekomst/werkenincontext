...
| Endpoint | Methode | Beschrijving |
|----------|---------|--------------|
| `/api/realtime/status` | GET | Connection status |
| `/api/realtime/subscribe` | POST | Subscribe to table changes |
| `/api/realtime/unsubscribe/:channel` | POST | Unsubscribe from channel |
| `/api/realtime/broadcast` | POST | Broadcast custom event |
| `/api/realtime/presence/document/:id` | GET | Get document viewers |

See [docs/REALTIME.md](docs/REALTIME.md) for detailed Supabase Realtime documentation.
