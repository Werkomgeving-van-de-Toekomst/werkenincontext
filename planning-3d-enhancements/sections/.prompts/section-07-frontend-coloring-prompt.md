...
Generate content for section `section-07-frontend-coloring` (filename: `section-07-frontend-coloring.md`).
...
for `section-07-frontend-coloring` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/section-07-frontend-coloring.md`
