...
Generate content for section `section-04-backend-properties` (filename: `section-04-backend-properties.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/marc/Projecten/iou-modern/planning-3d-enhancements/claude-plan.md` - Full implementation plan
2. `/Users/marc/Projecten/iou-modern/planning-3d-enhancements/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-backend-properties` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/section-04-backend-properties.md`
