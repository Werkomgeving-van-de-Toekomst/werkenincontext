...
Generate content for section `section-04-multi-stage-engine` (filename: `section-04-multi-stage-engine.md`).
...
for `section-04-multi-stage-engine` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/sections/section-04-multi-stage-engine.md`
