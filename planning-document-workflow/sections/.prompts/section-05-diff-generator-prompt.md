...
Generate content for section `section-05-diff-generator` (filename: `section-05-diff-generator.md`).
...
for `section-05-diff-generator` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/sections/section-05-diff-generator.md`
