...
Generate content for section `section-06-delegation-system` (filename: `section-06-delegation-system.md`).
...
for `section-06-delegation-system` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/sections/section-06-delegation-system.md`
