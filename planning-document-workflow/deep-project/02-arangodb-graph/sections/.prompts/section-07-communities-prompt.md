...
Generate content for section `section-07-communities` (filename: `section-07-communities.md`).
...
for `section-07-communities` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/section-07-communities.md`
