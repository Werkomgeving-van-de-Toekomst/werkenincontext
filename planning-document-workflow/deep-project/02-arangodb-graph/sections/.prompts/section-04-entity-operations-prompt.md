...
Generate content for section `section-04-entity-operations` (filename: `section-04-entity-operations.md`).
...
for `section-04-entity-operations` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/section-04-entity-operations.md`
