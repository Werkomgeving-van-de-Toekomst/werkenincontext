...
Generate content for section `section-06-graph-traversals` (filename: `section-06-graph-traversals.md`).
...
for `section-06-graph-traversals` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/section-06-graph-traversals.md`
