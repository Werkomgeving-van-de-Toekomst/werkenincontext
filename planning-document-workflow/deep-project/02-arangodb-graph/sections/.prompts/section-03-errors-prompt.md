...
Generate content for section `section-03-errors` (filename: `section-03-errors.md`).
...
for `section-03-errors` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/section-03-errors.md`
