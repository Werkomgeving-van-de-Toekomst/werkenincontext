...
Generate content for section `section-01-foundation-types` (filename: `section-01-foundation-types.md`).
...
for `section-01-foundation-types` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/01-entity-relationship-extraction/sections/section-01-foundation-types.md`
