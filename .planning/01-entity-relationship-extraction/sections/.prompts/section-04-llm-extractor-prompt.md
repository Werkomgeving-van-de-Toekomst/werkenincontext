...
Generate content for section `section-04-llm-extractor` (filename: `section-04-llm-extractor.md`).
...
for `section-04-llm-extractor` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/01-entity-relationship-extraction/sections/section-04-llm-extractor.md`
