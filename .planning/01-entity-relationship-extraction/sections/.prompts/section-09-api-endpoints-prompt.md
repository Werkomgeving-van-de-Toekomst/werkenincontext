...
Generate content for section `section-09-api-endpoints` (filename: `section-09-api-endpoints.md`).
...
for `section-09-api-endpoints` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/01-entity-relationship-extraction/sections/section-09-api-endpoints.md`
