...
Generate content for section `section-00-feasibility-spike` (filename: `section-00-feasibility-spike.md`).
...
for `section-00-feasibility-spike` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/01-entity-relationship-extraction/sections/section-00-feasibility-spike.md`
