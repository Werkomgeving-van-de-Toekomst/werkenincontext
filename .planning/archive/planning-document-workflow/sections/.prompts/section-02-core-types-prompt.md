...
Generate content for section `section-02-core-types` (filename: `section-02-core-types.md`).
...
for `section-02-core-types` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/sections/section-02-core-types.md`
