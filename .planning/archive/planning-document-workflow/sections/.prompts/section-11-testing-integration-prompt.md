...
Generate content for section `section-11-testing-integration` (filename: `section-11-testing-integration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/marc/Projecten/iou-modern/planning-document-workflow/claude-plan.md` - Full implementation plan
2. `/Users/marc/Projecten/iou-modern/planning-document-workflow/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/marc/Projecten/iou-modern/planning-document-workflow/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-11-testing-integration` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/sections/section-11-testing-integration.md`
