...
Generate content for section `section-08-version-storage` (filename: `section-08-version-storage.md`).
...
for `section-08-version-storage` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/sections/section-08-version-storage.md`
