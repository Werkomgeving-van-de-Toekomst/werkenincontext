...
Generate content for section `section-02-connection` (filename: `section-02-connection.md`).
...
for `section-02-connection` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/section-02-connection.md`
