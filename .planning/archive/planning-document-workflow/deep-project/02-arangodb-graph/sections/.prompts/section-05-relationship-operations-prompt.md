...
Generate content for section `section-05-relationship-operations` (filename: `section-05-relationship-operations.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/claude-plan.md` - Full implementation plan
2. `/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-05-relationship-operations` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/section-05-relationship-operations.md`
