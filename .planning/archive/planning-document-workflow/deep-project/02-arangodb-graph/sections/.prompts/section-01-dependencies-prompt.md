...
Generate content for section `section-01-dependencies` (filename: `section-01-dependencies.md`).
...
for `section-01-dependencies` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-document-workflow/deep-project/02-arangodb-graph/sections/section-01-dependencies.md`
