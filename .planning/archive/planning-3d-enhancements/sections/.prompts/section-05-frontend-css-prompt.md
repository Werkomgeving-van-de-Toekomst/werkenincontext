...
Generate content for section `section-05-frontend-css` (filename: `section-05-frontend-css.md`).
...
for `section-05-frontend-css` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/section-05-frontend-css.md`
