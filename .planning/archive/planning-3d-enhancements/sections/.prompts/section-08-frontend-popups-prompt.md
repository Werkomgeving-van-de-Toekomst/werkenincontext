...
Generate content for section `section-08-frontend-popups` (filename: `section-08-frontend-popups.md`).
...
for `section-08-frontend-popups` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/section-08-frontend-popups.md`
