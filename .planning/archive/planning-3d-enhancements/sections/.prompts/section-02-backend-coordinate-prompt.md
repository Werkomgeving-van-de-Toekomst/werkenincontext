...
Generate content for section `section-02-backend-coordinate` (filename: `section-02-backend-coordinate.md`).
...
for `section-02-backend-coordinate` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/section-02-backend-coordinate.md`
