...
Generate content for section `section-06-frontend-loading` (filename: `section-06-frontend-loading.md`).
...
for `section-06-frontend-loading` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/section-06-frontend-loading.md`
