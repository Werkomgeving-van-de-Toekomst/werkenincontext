...
Generate content for section `section-03-backend-wgs84` (filename: `section-03-backend-wgs84.md`).
...
for `section-03-backend-wgs84` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-3d-enhancements/sections/section-03-backend-wgs84.md`
