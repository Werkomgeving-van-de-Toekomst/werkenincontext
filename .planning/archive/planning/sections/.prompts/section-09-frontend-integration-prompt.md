...
Generate content for section `section-09-frontend-integration` (filename: `section-09-frontend-integration.md`).
...
for `section-09-frontend-integration` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-09-frontend-integration.md`
