...
Generate content for section `section-02-template-system` (filename: `section-02-template-system.md`).
...
for `section-02-template-system` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-02-template-system.md`
