...
Generate content for section `section-04-content-agent` (filename: `section-04-content-agent.md`).
...
for `section-04-content-agent` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/sections/section-04-content-agent.md`
