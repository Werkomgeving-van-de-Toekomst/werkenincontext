...
Generate content for section `section-06-geojson-support` (filename: `section-06-geojson-support.md`).
...
for `section-06-geojson-support` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/01-map-engine-3d/sections/section-06-geojson-support.md`
