...
Generate content for section `section-04-map3d-component` (filename: `section-04-map3d-component.md`).
...
for `section-04-map3d-component` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/01-map-engine-3d/sections/section-04-map3d-component.md`
