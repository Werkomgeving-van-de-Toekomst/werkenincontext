...
Generate content for section `section-07-layer-control` (filename: `section-07-layer-control.md`).
...
for `section-07-layer-control` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/01-map-engine-3d/sections/section-07-layer-control.md`
