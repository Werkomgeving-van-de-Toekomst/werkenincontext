...
Generate content for section `section-02-config-structures` (filename: `section-02-config-structures.md`).
...
for `section-02-config-structures` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning/01-map-engine-3d/sections/section-02-config-structures.md`
