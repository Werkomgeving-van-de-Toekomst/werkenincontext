...
Generate content for section `section-03-auth-realtime` (filename: `section-03-auth-realtime.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/marc/Projecten/iou-modern/planning-backend-eval/claude-plan.md` - Full implementation plan
2. `/Users/marc/Projecten/iou-modern/planning-backend-eval/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/marc/Projecten/iou-modern/planning-backend-eval/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-auth-realtime` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-backend-eval/sections/section-03-auth-realtime.md`
