...
Generate content for section `section-06-cleanup` (filename: `section-06-cleanup.md`).
...
for `section-06-cleanup` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-backend-eval/sections/section-06-cleanup.md`
