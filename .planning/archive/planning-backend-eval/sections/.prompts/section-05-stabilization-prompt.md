...
Generate content for section `section-05-stabilization` (filename: `section-05-stabilization.md`).
...
for `section-05-stabilization` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/planning-backend-eval/sections/section-05-stabilization.md`
