...
Generate content for section `section-07-observability` (filename: `section-07-observability.md`).
...
for `section-07-observability` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/features/agent-orchestration/sections/section-07-observability.md`
