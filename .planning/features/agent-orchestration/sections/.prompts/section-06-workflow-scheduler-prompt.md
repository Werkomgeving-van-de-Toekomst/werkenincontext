...
Generate content for section `section-06-workflow-scheduler` (filename: `section-06-workflow-scheduler.md`).
...
for `section-06-workflow-scheduler` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/features/agent-orchestration/sections/section-06-workflow-scheduler.md`
