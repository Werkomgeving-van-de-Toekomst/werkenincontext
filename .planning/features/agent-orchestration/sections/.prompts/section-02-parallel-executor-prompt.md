...
Generate content for section `section-02-parallel-executor` (filename: `section-02-parallel-executor.md`).
...
for `section-02-parallel-executor` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/features/agent-orchestration/sections/section-02-parallel-executor.md`
