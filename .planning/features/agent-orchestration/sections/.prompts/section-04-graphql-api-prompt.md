...
Generate content for section `section-04-graphql-api` (filename: `section-04-graphql-api.md`).
...
for `section-04-graphql-api` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/features/agent-orchestration/sections/section-04-graphql-api.md`
