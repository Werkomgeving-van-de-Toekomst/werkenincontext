...
Generate content for section `section-01-state-machine` (filename: `section-01-state-machine.md`).
...
for `section-01-state-machine` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/features/agent-orchestration/sections/section-01-state-machine.md`
