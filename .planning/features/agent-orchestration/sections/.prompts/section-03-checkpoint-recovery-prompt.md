...
Generate content for section `section-03-checkpoint-recovery` (filename: `section-03-checkpoint-recovery.md`).
...
for `section-03-checkpoint-recovery` to understand what this section should contain.
...
`/Users/marc/Projecten/iou-modern/.planning/features/agent-orchestration/sections/section-03-checkpoint-recovery.md`
